...
function getPlanetaryAges(event) {
  ...
  if (!currentAge) {
    ...
    const earthH2 = document.createElement("h2");
    ...
    earthH2.append("Your age on Earth is " + allPlanetAges[0] + " years old.");
...
function getYearsPassed() {
  ...
  if (!currentAge || !otherAge) {
    ...
    earthH2.append(allPlanetYears[0] + " Earth years have passed.");
...
function getFutureYears() {
  ...
  if (!currentAge || !otherAge) {
    ...
    earthH2.append(allPlanetYears[0] + " Earth years have yet to pass.");
